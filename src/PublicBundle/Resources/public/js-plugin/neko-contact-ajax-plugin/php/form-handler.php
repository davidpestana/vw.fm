...
if ($errors) {
    ...
    $mailBody .= $message . PHP_EOL . PHP_EOL;
    $mailBody .= "You can contact $name via email, $email or via phone $phone." . PHP_EOL . PHP_EOL;
    $mailBody .= "-------------------------------------------------------------------------------------------" . PHP_EOL;
    ...
    if(mail($to, $subject, $mailBody, $headers)){
        echo '<span class="alert alert-success">Success! Your message has been sent.</span>';
    }
}
