...
$(document).ready(function() {   
    ...
    s.src = "/bundles/public/js-plugin/jquery-cookie/jquery.cookie.js";
    $("body").append(s);  
        ...
        $('.flexslider').flexslider({
            ...
            start: function(slider){
             ...
             before: function(slider){
                ...
                Froogaloop(document.getElementById('player_1')).api('pause'); 
            },
    ...
    */ 
    if($('.isotopeWrapper').length){
        ...
        $(window).smartresize(function(){
            ...
            //$('.slides iframe').width($('.slides').width());
...
(function() {
    ...
    // ul to select
    var optionsList = '<option value="" selected>Menú...</option>';
